...
path_dataset = "D:\Projects\Movie Hut Project\Movie Hut\server\recommendation\file.csv"

data = pd.read_csv(path_dataset, sep=',', encoding='cp1252')
print('dataset length = ', len(data))

# Required columns - Title and movie plot
finaldata = data[["title", "description"]]
